...
class DetailsActivity:AppCompatActivity() {
        ...
        called.enqueue(object: Callback<MovieDetails>{
            ...
            override fun onResponse(call: Call<MovieDetails>, response: Response<MovieDetails>) {
                ...
                if(response.isSuccessful){
                    ...
                    Glide.with(this@DetailsActivity).load("https://image.tmdb.org/t/p/w500${posPath}").into(imgdisp)
                    Glide.with(this@DetailsActivity).load("https://image.tmdb.org/t/p/w500${response.body()?.backdrop_path}").listener(object:
    ...
    fun shareButton(view: View) {
        ...
        sh.type="text/plain"
        sh.putExtra(Intent.EXTRA_TEXT,"Come watch '$name' with me: https://image.tmdb.org/t/p/w500$posPath")
