...
class ActorMoviesAdapter(private val actorMovies: List<CastA>) :
    RecyclerView.Adapter<ActorMovieHolder>() {
    ...
    fun bind(actorMovie: CastA) {
        ...
        if (actorMovie.poster_path != null) {
            Glide.with(itemView.context)
                .load("https://image.tmdb.org/t/p/w500${actorMovie.poster_path}")
