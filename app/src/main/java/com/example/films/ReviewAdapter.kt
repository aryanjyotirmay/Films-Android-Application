...
class ReviewAdapter(private val reviews: List<revResult>) :RecyclerView.Adapter<ReviewViewHolder>() {
...
//        }
  //      if(cast.author_details.avatar_path.startsWith("/")) {}
            ...
            Glide.with(itemView.context)
                .load("https://image.tmdb.org/t/p/w500${cast.author_details.avatar_path}").error(R.drawable.images_2)
                .into(imageR)
