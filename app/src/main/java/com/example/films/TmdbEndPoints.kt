...
interface TmdbEndpoints {
    ...
    fun getSimilar(@Path("id") id:Int,@Query("api_key") key:String): retrofit2.Call<PopularMovies>

    @GET("/3/search/movie")
    fun searchMovie(@Query("api_key") key: String,@Query("query") movieName: String): retrofit2.Call<PopularMovies>
    ...
    fun getMoviesActor(@Path("id") id:Int,@Query("api_key") key:String):retrofit2.Call<DataActorMovies>
